<#
HAFEZ v2.0.1 — Quick Fix Script (v2, ASCII-safe)
- Patch paths in src/pages/index.html for GitHub Pages
- Seed week JSONs if missing (valid minimal examples)
- Optional: git add/commit/push if git is available

Usage example:
  powershell -ExecutionPolicy Bypass -File .\HAFEZ_fix_paths_and_seed_v2.ps1 -RepoPath "." -Week 5
#>
...
if ($gitOk){
  ...
  Warn "git not found. Use GitHub Desktop to Commit & Push."
}
